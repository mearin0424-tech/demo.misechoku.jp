...
<div class="admin-page">
    @include('admin.parts.page-title', [
        ...
        'info' => '
            ...
            <ul>
                <li>セリフが空欄かつ表示ONの画面では、オコジョキャラのみ表示され吹き出しは出ません。</li>
                <li>表示OFFにした画面ではキャラクター自体が表示されません。</li>
                <li>各画面のテンプレ側で <code>@yield(\'guide_message\')</code> が明示的に文言を指定している場合は、その文言が優先されます。</li>
            </ul>
        ',
    ])
