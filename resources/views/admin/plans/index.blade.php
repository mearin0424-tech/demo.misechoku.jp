                ...
                <tbody>
                    @forelse($subscriptions as $sub)
                        ...
                        <tr>
                            ...
                            <td>{{ $sub->shop_display_name }}<br><small style="color:#8b8b96;">{{ $sub->shop_id }}</small></td>
                            <td>Premium（{{ $sub->cycleLabel() }}）</td>
                            <td>¥{{ number_format((int) $sub->amount) }}</td>
                            <td>
                            ...
                            <td>{{ optional($sub->ends_at)->format('Y/m/d') ?: '—' }}</td>
                    ...
                    @empty
                        <tr><td colspan="9" style="text-align:center; color:#8b8b96; padding: 28px 0;">プラン契約はまだありません。</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
