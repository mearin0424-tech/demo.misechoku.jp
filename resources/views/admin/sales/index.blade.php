    ...
    <section class="admin-panel">
        <div class="u-flex-between u-mb-12">
            ...
            <div class="sales-chart-legend">
                <span><i class="legend-dot" style="background:#eba8c8;"></i> 仲介料収益（円）</span>
        ...
        <div class="sales-chart-wrap">
            <svg viewBox="0 0 {{ $chartWidth }} {{ $chartHeight }}" preserveAspectRatio="none" class="sales-chart">
                ...
                {{-- 仲介料収益（折れ線・主） --}}
                <polyline points="{{ $commissionPoly }}" fill="none" stroke="#b0507f" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/>
                @foreach($commissionPoints as $i => $p)
                    <circle cx="{{ round($p['x'], 1) }}" cy="{{ round($p['y'], 1) }}" r="3.5" fill="#eba8c8" stroke="#fff" stroke-width="1.5"/>
                @endforeach
