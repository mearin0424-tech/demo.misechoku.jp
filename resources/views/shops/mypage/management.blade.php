...
<style>
    ...
    .case-card__invoice-link {
        ...
        background: rgba(197,160,89,0.08); border: 1px solid var(--color-border-strong);
        color: var(--gold-light); text-decoration: none;
    }
    .case-card__invoice-link:hover { background: rgba(197,160,89,0.16); color: var(--color-text-header); }
