...
<style>
    ...
    .shop-profile-edit {
        ...
        --spe-field: #110f0d;
        --spe-border: #2a2015;
        --spe-border-focus: rgba(var(--accent-rgb, 214, 112, 162), 0.5);
        --spe-gold: #eba8c8;
        --spe-muted: #71717a;
        --spe-hint: #52525b;
    ...
    .shop-profile-edit__station-row {
        ...
        gap: 8px;
        padding: 8px;
        border: 1px solid var(--color-border, rgba(var(--accent-rgb, 214, 112, 162), 0.22));
        border-radius: 10px;
        background: rgba(255,255,255,0.02);
        transition: border-color 0.15s ease, background 0.15s ease;
    }
    .shop-profile-edit__station-row:first-child {
        border-color: var(--gold, #eba8c8);
        background: rgba(var(--accent-rgb, 214, 112, 162), 0.06);
    }
    .shop-profile-edit__station-row.is-dragging { opacity: 0.55; }
    .shop-profile-edit__station-row.is-ghost { background: rgba(var(--accent-rgb, 214, 112, 162), 0.18); }
    ...
    .shop-profile-edit__station-drag:hover { color: var(--gold, #eba8c8); background: rgba(var(--accent-rgb, 214, 112, 162), 0.10); }
    ...
    .shop-profile-edit__station-row:first-child .shop-profile-edit__station-badge { color: var(--gold, #eba8c8); }
    .shop-profile-edit__station-badge .is-main-pill {
        ...
        font-size: 0.62rem;
        font-weight: 800;
        background: linear-gradient(135deg, var(--gold-light, #f2cadf), var(--gold, #eba8c8));
        color: #1a1206;
    }
    ...
    .shop-profile-edit__station-set-main:hover {
        ...
        color: var(--gold-light, #f2cadf);
        border-color: var(--color-border-strong, rgba(var(--accent-rgb, 214, 112, 162), 0.4));
    }
    ...
    .shop-profile-edit__station-info i { color: var(--gold, #eba8c8); margin-top: 2px; }
    .shop-profile-edit__station-add {
        ...
        color: var(--spe-gold);
        background: transparent;
        border: 1px dashed rgba(var(--accent-rgb, 214, 112, 162), 0.35);
        border-radius: 8px;
        cursor: pointer;
    }
    ...
    .shop-profile-edit__chip input:checked + span {
        ...
        background: #2a2210;
        color: var(--spe-gold);
        box-shadow: 0 0 10px rgba(var(--accent-rgb, 214, 112, 162), 0.1);
    }
    .shop-profile-edit__chip input:focus-visible + span {
        outline: 2px solid rgba(var(--accent-rgb, 214, 112, 162), 0.45);
        outline-offset: 2px;
    }
    ...
    .shop-profile-edit__submit {
        ...
        cursor: pointer;
        color: #141210;
        background: linear-gradient(to right, #eba8c8, #b8942b);
        box-shadow: 0 4px 15px rgba(var(--accent-rgb, 214, 112, 162), 0.15);
