...
<style>
    .job-edit-v2 {
        ...
        --je-border: rgba(var(--accent-rgb, 214, 112, 162), 0.22);
        --je-gold: #eba8c8;
    ...
    .job-edit-v2__top {
        ...
        border-bottom: 1px solid rgba(var(--accent-rgb, 214, 112, 162), 0.22);
    }
    .job-edit-v2__back {
        color: #a1a1aa;
        padding: 4px;
    ...
    .job-edit-v2__sec-title {
        ...
        margin: 0 0 20px;
        padding-bottom: 10px;
        border-bottom: 1px solid rgba(var(--accent-rgb, 214, 112, 162), 0.18);
        font-size: 1rem;
        font-family: var(--font-sans);
        font-weight: 700;
        color: #fff;
    ...
    .job-edit-v2__sec-title i { font-size: 0.9rem; color: #eba8c8; }
    ...
    .job-edit-v2__textarea:focus {
        outline: none;
        border-color: rgba(var(--accent-rgb, 214, 112, 162), 0.6);
    ...
    .job-edit-v2__card--accent::before {
        ...
        bottom: 0;
        width: 4px;
        background: rgba(var(--accent-rgb, 214, 112, 162), 0.45);
    }
    ...
    .job-edit-v2__chip input:checked + span {
        ...
        color: #f2cadf;
        box-shadow: 0 0 10px rgba(var(--accent-rgb, 214, 112, 162), 0.18);
    }
    ...
    .job-edit-v2__preview-link:hover { background: rgba(var(--accent-rgb, 214, 112, 162), 0.08); }
    ...
    .job-edit-v2__footer {
        ...
        backdrop-filter: blur(10px);
        border-top: 1px solid rgba(var(--accent-rgb, 214, 112, 162), 0.22);
        box-sizing: border-box;
    }
    ...
    .job-edit-v2__notice i { flex-shrink: 0; margin-top: 3px; color: #f2cadf; }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (copyBtn) {
        ...
        copyBtn.addEventListener('click', function () {
            ...
            copyBtn.style.color = '#eba8c8';
            copyBtn.style.borderColor = 'rgba(var(--accent-rgb, 214, 112, 162), 0.5)';
            setTimeout(function () {
