                        ...
                        <div class="talk-info">
                            ...
                            <div class="flex justify-between items-center mt-1">
                                ...
                                @if(!empty($talk['has_fulltime_request_badge']))
                                    <span class="unread-badge" style="background:linear-gradient(135deg,#ffe2a3,#dcb568 45%,#b8860b);color:#2a1406;">本入店希望</span>
                                @endif
                            </div>
                        </div>
                    </a>
                            ...
                            <div class="request-main">
                                ...
                                <div class="request-content">
                                    ...
                                    <div class="request-meta-row">
                                        ...
                                        @if(!empty($talk['has_fulltime_request_badge']))
                                            <span class="unread-badge" style="margin-left:8px; background:linear-gradient(135deg,#ffe2a3,#dcb568 45%,#b8860b);color:#2a1406;">本入店希望</span>
                                        @endif
                                    </div>
