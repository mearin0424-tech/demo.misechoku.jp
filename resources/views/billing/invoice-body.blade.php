{{--
  ...
  template_only: 体裁のみ（数値・日付の数字を含まないプレースホルダー）
--}}
<div class="invoice-wrap">
    <div class="invoice-header">
        ...
        @if(!empty($invoice['template_only']))
            <div class="invoice-meta">
                請求書番号: （発行時に採番）<br>
                発行日: （発行時に記載）<br>
                支払期限: （発行日より所定日数後 ※運用設定に準拠）
            </div>
        @else
            <div class="invoice-meta">
    ...
    @if(!empty($invoice['template_only']))
        <div class="invoice-to">
            <p class="invoice-to-name">（店舗名）御中</p>
        ...
        <div class="invoice-total">
            ...
            <div class="invoice-total-value">¥（発行時に確定）</div>
        </div>
