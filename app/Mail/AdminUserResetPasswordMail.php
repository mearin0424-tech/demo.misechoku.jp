...
class AdminUserResetPasswordMail extends Mailable
{
...
*/
    public function build()
    {
        ...
        $url = URL::temporarySignedRoute('admin_password_reset.edit', $now->addHours(\CommonConsts::PASSWORD_RESET_HOURS), $tokenParam);
